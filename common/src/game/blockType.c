...
void blockTypeInitBlock(u8 b, u32 tex, blockCategory ncat,const char *bname,int nhp, int nfirehp,u32 ncolor1,u32 ncolor2){
	for(int i=0;i<6;i++){
...
void blockTypeInit(){
	blockTypeInitBlock( 1, 1, DIRT,  "Dirt",           200,  200, 0xFF0A234F,0xFF051B45);
	blockTypeInitBlock( 2, 7, DIRT,  "Grass",          240,  240, 0xFF004227,0xFF051B45); blockTypeSetTex(2,2,0); blockTypeSetTex(2,3,1);
	...
	blockTypeInitBlock(14,13, STONE, "Marble Pillar", 1600, 8000, 0xFFF0F0F0,0xFFEBEBEB); blockTypeSetTex(14,2,12); blockTypeSetTex(14,3,12);
	blockTypeInitBlock(15,14, STONE, "Marble Blocks", 1600, 8000, 0xFFF0F0F0,0xFFEBEBEB);
	blockTypeInitBlock(16,16, WOOD,  "Hewn Log",       400,  700, 0xFF09678f,0xFF1380af); blockTypeSetTex(16,2,15); blockTypeSetTex(16,3,15);
