...
void blockTypeInit(){
	...
	blockTypeInitBlock( 6, 5, LEAVES,"Spruce Leafes",  110, 0xFF012C12,0xFF01250F);
	...
	blockTypeInitBlock(11,10, LEAVES,"Oak Leaves",     100, 0xFF004227,0xFF003318);
	...
	blockTypeInitBlock(19,19, LEAVES,"Sakura Leafes",  120, 0xFF997CE8,0xFF4D25B5);
	blockTypeInitBlock(20,20, WOOD,  "Birch Log",      500, 0xFF525255,0xFF525555);
	blockTypeInitBlock(21,21, LEAVES,"Flower Bush",    160, 0xFF004227,0xFF003318);
