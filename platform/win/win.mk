...
wolkenwelten.exe: client/client.d releases/win/wolkenwelten.res $(CLIENT_OBJS) $(ASM_OBJS) $(CLIENT_TMP_OBJS)
...
wolkenwelten-server.exe: server/server.d releases/win/wolkenwelten-server.res $(SERVER_OBJS) $(ASM_OBJS) common/src/tmp/cto.o server/src/tmp/assets.o
